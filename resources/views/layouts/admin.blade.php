    ...
    <div>
        ...
        <div id="admin-layout">
            <aside id="admin-sidebar">
                <div class="card {{ $routeName == 'admin.home' ? 'border-warning' : ''}}">
                    <div class="card-header {{ $routeName == 'admin.home' ? 'text-warning' : ''}}">
                        Dashboard
                    </div>
                ...
                {{-- <div class="card {{ str_contains(Route::currentRouteName(), 'projects.') ? 'border-warning' : ''}}"> --}}
                <div class="card {{ routeNameContains('projects.') ? 'border-warning' : ''}}">
                    <div class="card-header {{ routeNameContains('projects.') ? 'text-warning' : ''}}">
                        Projects
                    </div>
                    <div class="list-group list-group-flush">
                        <a href="{{route('admin.projects.index')}}" class="list-group-item list-group-item-action {{ routeNameContains('projects.index') ? 'active' : ''}}">Index</a>
                        <a href="{{route('admin.projects.create')}}" class="list-group-item list-group-item-action {{ routeNameContains('projects.create') ? 'active' : ''}}">Add Project</a>
